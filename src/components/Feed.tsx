...
export const Feed: React.FC = () => {
  ...
  const handleGenerateMockData = async () => {
    try {
      ...
      toast.info('Generating posts for our 5 profiles...', {
        description: 'This may take a few minutes. Each profile will create 5 posts with images generated by Google\'s Imagen.'
      });
      
      await generateMockData();
      
      toast.success('Content generated successfully!', {
        description: 'Refresh the page to see all the new posts from Maya, Aiden, Eleanor, Jayden, and Olivia.'
      });
    } catch (error) {
      console.error('Error generating mock data:', error);
      toast.error('Failed to generate content', {
        description: 'Please make sure REPLICATE_API_KEY is set in Supabase Edge Function Secrets.'
      });
    } finally {
    ...
    <div>
      <div className="mb-6 flex flex-col space-y-4 bg-gray-50 p-4 rounded-lg border border-gray-100">
        ...
        <p className="text-sm text-gray-600">
          Create posts for our 5 profiles: Maya Chen, Aiden Rodriguez, Eleanor Wright, Jayden Park, and Olivia Santos.
        </p>
